...
public class KoelnerPhonetikEncoder implements StringEncoder {
    ...
    /**
     * @param useOnlyPrimaryCode true if only primary code should be used
     */
    ...
    /*public double getRelativeValue(Object o1, Object o2) {
        ...
        for (String aKopho1 : kopho1) {
            for (String aKopho2 : kopho2) {
                if (aKopho1.equals(aKopho2)) {
                    return 1;
                }
            }
        }
